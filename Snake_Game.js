 ...
 *
 * 📆 2주차 개발 (2025.11.XX)
 * 🧑‍💻 A (Player): 뱀 조작 및 생존 (키보드 입력, 자기 몸 충돌)
 * 🧑‍💻 B (Environment): 게임 환경 및 규칙 (게임 루프, 먹이/벽 충돌, 점수)
 *
 * ---
 * 🧭 이름 짓기 5원칙
 * 1. 영어로 짓기 (snake O, baem X)
 * 2. camelCase 사용 (isGameOver O, isgameover X)
 * 3. 변수는 '명사' (snake, food, score)
 * 4. 함수는 '동사 + 명사' (drawSnake, checkCollision)
 * 5. T/F 변수는 'is'나 'has'로 (isGameOver)
 * ---
 */
